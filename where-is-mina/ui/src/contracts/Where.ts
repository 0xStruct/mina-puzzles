...
class WhereZkApp extends SmartContract {
  ...
  @method submitSolution(submission1: Field, submission2: Field) {
    let submissionHash = Poseidon.hash([submission1, submission2]);
