 ...
 * Run with node:     `$ node build/src/Tictactoe.run.js`.
 */
...
// play
console.log('\n\n====== SECOND MOVE ======\n\n');
await makeMove(player2, player2Key, 0, 2);
// debug
b = zkApp.board.get();
new Board(b).printState();
...
// play
console.log('\n\n====== FOURTH MOVE ======\n\n');
await makeMove(player2, player2Key, 1, 2);
...
// play
console.log('\n\n====== FIFTH MOVE ======\n\n');
await makeMove(player1, player1Key, 2, 0);
...
// play
console.log('\n\n====== SIXTH MOVE ======\n\n');
await makeMove(player2, player2Key, 2, 2);
...
console.log("isNextPlayer1", isNextPlayer1.toString());

// if isNextPlayer1 is true, then current player is player 2
console.log('did someone win?', isNextPlayer1 ? 'Player 2!' : 'Player 1!');
// cleanup
