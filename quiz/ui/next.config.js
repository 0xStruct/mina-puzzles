...
const nextConfig = {
   ...
   */
  basePath: process.env.NODE_ENV === 'production' ? '' : '', // update basePath if you change your repo name
  assetPrefix: process.env.NODE_ENV === 'production' ? '' : '' // update assetPrefix if you change your repo name. 
};
